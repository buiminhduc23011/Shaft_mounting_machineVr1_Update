...
{
    /// <summary>
    /// Interaction logic for Mode_2_Cum_Lap.xaml
    /// </summary>
    public partial class Mode_2_Cum_Lap : UserControl
    {
        ...
        dynamic data;
        public Mode_2_Cum_Lap()
        {
            InitializeComponent();
        }
        private void Mode_2_Cum_Lap_Screen_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void Mode_2_Cum_Lap_Screen_Unloaded(object sender, RoutedEventArgs e)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    Dispatcher.Invoke(() =>
                    {
                        ...
                        if (data != null)
                        {
                            update.bt_Colors_Status_1(bt_Jog_Up, Convert.ToString(data.Jog_Up_Cum_Lap));
                            update.bt_Colors_Status_1(bt_Jog_Down, Convert.ToString(data.Jog_Down_Cum_Lap));
                            update.bt_Colors_Status_1(bt_Jog_Mo, Convert.ToString(data.Jog_Mo_Cum_Lap));
                            update.bt_Colors_Status_1(bt_Jog_Kep, Convert.ToString(data.Jog_Kep_Cum_Lap));
                        }
                    });
                }
                catch
        ...
        {
            Control("Jog_Up_Cum_Lap", false, 2);
        }
        ...
        {
            Control("Jog_Down_Cum_Lap", true, 2);
        }
        //
        private void bt_Jog_Kep_TouchUp(object sender, TouchEventArgs e)
        {
            Control("Jog_Kep_Cum_Lap", false, 2);
        }
